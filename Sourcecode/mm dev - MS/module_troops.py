...
#Multiplayer troops
  ...
  ["british_hussar_nco","1st KGL Hussars","Sergeant",tf_mounted|tf_guarantee_all,0,0,fac_british_ranks,
   ...
   def_attrib|level(20),wpex(160,5,30,5,30,5),knows_common|knows_riding_6|knows_ironflesh_3|knows_power_strike_3,swadian_face_middle_1, swadian_face_old_2],
  ["british_hussar_officer","1st KGL Hussars","Officer",tf_mounted|tf_guarantee_all,0,0,fac_british_ranks,
   ...
   def_attrib|level(20),wpex(160,5,30,5,30,5),knows_common|knows_riding_6|knows_ironflesh_3|knows_power_strike_3,swadian_face_middle_1, swadian_face_old_2],
  ["british_hussar_bugle","1st KGL Hussars","Bugler",tf_mounted|tf_guarantee_all,0,0,fac_british_ranks,
  ...
  ["british_sapper","Sapper","Engineer",tf_guarantee_all,0,0,fac_britain,
   ...
   def_attrib_multiplayer|level(20),wpex(70,5,30,5,30,5),knows_common|knows_ironflesh_3|knows_power_strike_2|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ["british_ship","Ship Crew","Infantry",tf_guarantee_all,0,0,fac_britain,
   [itm_sailor_pants,itm_british_seaman_hat,itm_british_seaman_hat_2,itm_british_musician_sword_invis,itm_british_baker_bayonet,itm_russian_peasant_axe,itm_russian_peasant_knife,itm_russian_peasant_rogatina,itm_russian_peasant_rogatina,itm_russian_peasant_rogatina,itm_russian_peasant_rogatina,itm_sapper_axe_ship,itm_sapper_axe_ship,itm_sapper_axe_rus_ship,itm_russian_peasant_2handed_axe,itm_bullets,itm_russian_gusarskiy_karabin,itm_pistol_ammo,itm_british_pistol,itm_british_pistol,itm_british_pistol],
  ...
  ["british_ship_cannon","Ship Crew","Naval Artillery",tf_guarantee_all,0,0,fac_british_ranks,
   [itm_sailor_pants,itm_british_seaman_hat,itm_british_seaman_hat_2,itm_ramrod,itm_cannon_lighter,itm_british_musician_sword_invis],
   def_attrib_multiplayer|level(20),wpex(80,5,80,5,130,80),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ["british_ship_marine","Ship Crew","Marine, 1st Battalion - Royal Marines",tf_guarantee_all,0,0,fac_british_ranks,
   [itm_british_royal_marine,itm_british_coldstream_pants,itm_royal_marine_hat,itm_royal_marine_hat,itm_royal_marine_hat,itm_royal_marine_hat,itm_royal_marine_beret,itm_british_brown_bess,itm_bullets],
   def_attrib_multiplayer|level(20),wpex(50,5,130,5,150,5),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ...
  ["french_infantry_vistula_flute","Legion de la Vistule","Fifer",tf_guarantee_all,0,0,fac_french_ranks,
   ...
   def_attrib_multiplayer|level(20),wpex(80,5,80,5,50,5),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ["french_infantry_bavarian","2. Linien-Infanterie-Regiment Kronprinz, Bayern.","Line Infantry",tf_guarantee_all,0,0,fac_france,
   [itm_french_bavarian_inf_ranker,itm_french_bavarian_infantry_pants,itm_french_bavarian_helmet_other_ranks,itm_bullets,itm_russian_musket_1808,itm_french_briquet],
   def_attrib_multiplayer|level(20),wpex(50,5,130,5,150,5),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ["french_infantry_bavarian_nco","2. Linien-Infanterie-Regiment Kronprinz, Bayern.","Colour Bearer",tf_guarantee_all,0,0,fac_french_ranks,
   [itm_french_bavarian_inf_flagcarrier,itm_french_bavarian_infantry_pants,itm_french_bavarian_helmet_flagcarrier,itm_bavarian_flag_national,itm_bavarian_flag_regimental,itm_french_briquet],
   def_attrib_multiplayer|level(20),wpex(80,5,80,5,50,5),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ["french_infantry_bavarian_officer","2. Linien-Infanterie-Regiment Kronprinz, Bayern.","Officer",tf_guarantee_all,0,0,fac_french_ranks,
   [itm_french_bavarian_inf_officer,itm_french_bavarian_officer_boots,itm_french_bavarian_helmet_officer,itm_french_inf_off_sabre,itm_pistol_ammo,itm_french_officer_pistol,itm_french_pistol_1766,itm_officer_gloves,itm_spyglass],
   def_attrib_multiplayer|level(20),wpex(80,5,80,5,50,5),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ["french_infantry_bavarian_drum","2. Linien-Infanterie-Regiment Kronprinz, Bayern.","Drummer",tf_guarantee_all,0,0,fac_french_ranks,
   [itm_french_bavarian_inf_drummer,itm_french_bavarian_infantry_pants,itm_french_bavarian_helmet_other_ranks,itm_drummer_gloves,itm_drumstick_right,itm_french_briquet],
   def_attrib_multiplayer|level(20),wpex(80,5,80,5,50,5),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ["french_infantry_bavarian_flute","2. Linien-Infanterie-Regiment Kronprinz, Bayern.","Fifer",tf_guarantee_all,0,0,fac_french_ranks,
   [itm_french_bavarian_inf_flutist,itm_french_bavarian_infantry_pants,itm_french_bavarian_helmet_other_ranks,itm_flute,itm_french_briquet],
   def_attrib_multiplayer|level(20),wpex(80,5,80,5,50,5),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ...
  ["french_sapper","Sappeur","Engineer",tf_guarantee_all,0,0,fac_france,
   ...
   def_attrib_multiplayer|level(20),wpex(70,5,30,5,30,5),knows_common|knows_ironflesh_3|knows_power_strike_2|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ["french_ship","Ship Crew","Infantry",tf_guarantee_all,0,0,fac_france,
   [itm_french_sailor_pants,itm_french_seaman_hat,itm_french_seaman_hat,itm_french_seaman_hat_2,itm_french_briquet,itm_french_sappeur_sword,itm_russian_peasant_axe,itm_russian_peasant_knife,itm_russian_peasant_rogatina,itm_russian_peasant_rogatina,itm_russian_peasant_rogatina,itm_russian_peasant_rogatina,itm_sapper_axe_ship,itm_sapper_axe_rus_ship,itm_sapper_axe_rus_ship,itm_russian_peasant_2handed_axe,itm_bullets,itm_russian_gusarskiy_karabin,itm_pistol_ammo,itm_french_pistol_1766,itm_french_pistol_1766,itm_french_pistol_1766],
   def_attrib_multiplayer|level(20),wpex(80,5,80,5,130,80),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ["french_ship_cannon","Ship Crew","L'Artillerie Navale",tf_guarantee_all,0,0,fac_french_ranks,
   ...
   def_attrib_multiplayer|level(20),wpex(80,5,80,5,130,80),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
  ["french_ship_marine","Ship Crew","Marine, 24e Bataillon des Equipages",tf_guarantee_all,0,0,fac_french_ranks,
   [itm_french_equipage_batallion,itm_french_equipage_batallion_pants,itm_french_marine_hat,itm_french_charleville,itm_bullets],
   def_attrib_multiplayer|level(20),wpex(50,5,130,5,150,5),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_athletics_3,swadian_face_middle_1, swadian_face_old_2],
